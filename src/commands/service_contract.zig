...
pub fn buildServiceSnapshotJson(allocator: std.mem.Allocator, app: *const app_context.AppContext, extra_fields_json: ?[]const u8) anyerror![]u8 {
    ...
    return std.fmt.allocPrint(
        allocator,
        "{{\"serviceState\":\"{s}\",\"installed\":{s},\"enabled\":{s},\"autostart\":{s},\"daemonState\":\"{s}\",\"daemonProjected\":true,\"pid\":{?},\"lockHeld\":{s},\"restartBudgetRemaining\":{d},\"staleProcessDetected\":{s},\"gatewayRunning\":{s},\"hostRunning\":{s},\"hostLoopActive\":{s},\"gatewayHandlerAttached\":{s},\"bindHost\":\"{s}\",\"bindPort\":{d},\"installCount\":{d},\"startCount\":{d},\"stopCount\":{d},\"restartCount\":{d},\"hostStartCount\":{d},\"hostTickCount\":{d},\"lastTransitionMs\":{?}{s}}}",
        .{
