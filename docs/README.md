...
- `reference-aligned-ourclaw` 是当前主入口
- `architecture/` 与 `contracts/` 是 supporting 说明
- `planning/` 与 `backup/` 主要用于历史恢复和背景参考
