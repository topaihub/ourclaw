...
1. 打开 `ourclaw/docs/specs/reference-aligned-ourclaw/tasks.md`
2. 按当前未完成 wave 顺序挑一个任务项
...
当前进度：本文件所述状态是历史快照；当前进度请以 `reference-aligned-ourclaw/tasks.md`、`session-resume.md` 与 `current-task-board.md` 为准。

当前要继续的任务是：**从 `reference-aligned-ourclaw/tasks.md` 里选择当前 wave，而不是继续回到旧 M2 任务。**
